...
//           { id: 'ptsName', label: 'Patient Name', type: 'text', required: true },
//           { id: 'husbandName', label: 'Husband / Father Name', type: 'text' },
//           { id: 'phone', label: 'Phone Number', type: 'text' },
//           { id: 'age', label: 'Age', type: 'number' },
//           { id: 'sex', label: 'Sex', type: 'dropdown', options: [{ label: 'Male', value: 'M' }, { label: 'Female', value: 'F' }] },
//           { id: 'refDr', label: 'Ref Dr', type: 'text' }
//         ]
//       },
//       {
//         id: 'scan_selection',
...
//               { label: 'Transrectal', value: 'transrectal' }
//             ]
//           },
...
//         fields: [
//           { id: 'find_liver', label: 'Liver', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_gb', label: 'GB', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_cd', label: 'CD', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_pancreas', label: 'Pancreas', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_spleen', label: 'Spleen', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_aorta', label: 'Aorta', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_rk', label: 'Rt Kidney', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_lk', label: 'Lt Kidney', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_bladder', label: 'Bladder', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_prostate', label: 'Prostate gland', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_transrectal', label: 'Transrectal', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_pelvis', label: 'PELVIS', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_uterus', label: 'Uterus', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_rov', label: 'R.OV', type: 'text', placeholder: 'Enter findings...' },
//           { id: 'find_lov', label: 'L.OV', type: 'text', placeholder: 'Enter findings...' }
//         ]
//       },
//       {
//         id: 'history_gen',
...
//         fields: [
//           { id: 'indication', label: 'Indication for scan', type: 'text' },
//           { id: 'pain_abd', label: 'Pain In Abdomen', type: 'radio', options: [{ label: 'Yes', value: 'yes' }, { label: 'No', value: 'no' }] },
//           { id: 'pain_site', label: 'Pain Site', type: 'text' },
//           { id: 'radiation', label: 'Radiation', type: 'text' },
//           { id: 'food_relation', label: 'Relation to food', type: 'text' }
//         ]
//       },
//       {
//         id: 'risk_factors',
...
//           {
//             id: 'nab_matrix',
//             label: 'Fetal Anatomy N/AB Matrix',
//             type: 'nab-matrix',
//             rows: [
...
export const DEFAULT_SCHEMAS: Record<string, Partial<MedicalTemplate>> = {
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { id: 'risk_smoke', label: 'Smoking', type: 'checkbox' },
          { id: 'risk_fever', label: 'Fever', type: 'checkbox' },
          { id: 'loss_wt', label: 'Loss of appetite/weight', type: 'text' },
          { id: 'hist_dm', label: 'Family h/o Diabetes', type: 'textarea' },
          { id: 'hist_ht', label: 'Family h/o Hypertension', type: 'textarea' },
          { id: 'other_risk', label: 'Other Risk Factors', type: 'textarea' }
        ]
      },
      {
        ...
        title: 'Clinical Observations',
        fields: [
          { id: 'bowel', label: 'Bowel Habits', type: 'text' },
          { id: 'micturition', label: 'Micturition', type: 'dropdown', options: [{ label: 'Normal', value: 'norm' }, { label: 'Burning', value: 'burn' }, { label: 'Frequent', value: 'freq' }] },
          { id: 'jaundice', label: 'Jaundice', type: 'radio', options: [{ label: 'Yes', value: 'yes' }, { label: 'No', value: 'no' }] },
          { id: 'edema', label: 'Edema', type: 'radio', options: [{ label: 'Yes', value: 'yes' }, { label: 'No', value: 'no' }] }
        ]
      },
      {
        ...
        title: 'Medical / Surgical History',
        fields: [
          { id: 'hist_surg', label: 'H/O Surgery', type: 'text' },
          { id: 'normal_case', label: 'Normal Case History', type: 'radio', options: [{ label: 'Yes', value: 'yes' }, { label: 'No', value: 'no' }] },
          { id: 'hist_med', label: 'Past Medical History', type: 'textarea' },
          { id: 'invest', label: 'Investigations', type: 'textarea' }
      ...
      },
      {
        ...
        fields: [
          ...
          { id: 'menopause', label: 'Age of Menopause', type: 'number' },
          { id: 'children', label: 'No. of children', type: 'number' },
          { id: 'last_birth', label: 'Last child birth', type: 'text' },
          { id: 'risk_hypertension', label: 'Hypertension', type: 'text', placeholder: 'BP Control...' },
          { id: 'risk_diabetes', label: 'Diabetes', type: 'textarea', placeholder: 'Severity/Duration...' },
          { id: 'surg_hx', label: 'H/O Surgery', type: 'textarea' },
          { id: 'investigations', label: 'Investigations', type: 'textarea' },
          { id: 'follow_up', label: 'Follow Up (Y/N)', type: 'radio', options: [{ label: 'Yes', value: 'yes' }, { label: 'No', value: 'no' }] },
          { id: 'normal_case_hist', label: 'Normal Case History', type: 'radio', options: [{ label: 'Yes', value: 'yes' }, { label: 'No', value: 'no' }] }
        ]
      }
    ]
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { id: 'husbandName', label: 'Husband / Father Name', type: 'text' },
          { id: 'phone', label: 'Phone Number', type: 'text' },
          { id: 'uid', label: 'UID Number', type: 'text' },
          { id: 'scanDate', label: 'Scan date', type: 'date' },
          { id: 'Heart rate', label: 'Heart Rate', type: 'number' }
        ]
      },
      {
        ...
        fields: [
          { id: 'penetration', label: 'Penetration', type: 'radio', options: [{ label: 'Good', value: 'good' }, { label: 'Poor', value: 'poor' }] },
          { id: 'position', label: 'Position', type: 'radio', options: [{ label: 'Good', value: 'good' }, { label: 'Poor', value: 'poor' }] },
          { id: 'situs', label: 'Situs', type: 'text' },
  ...
  'Medical History': {
    ...
    sections: [
      ...
      },
      {
        ...
        title: 'History: Hypertension',
        fields: [
          { id: 'ht', label: 'Hypertension (HT)', type: 'checkbox' },
          {
            id: 'ht_type', label: 'Select Type', type: 'checkbox-group', options: [
              { label: 'PRE-GESTATIONAL HYPERTENSION', value: 'pre' },
              { label: 'PIH (PREGNANCY INDUCED HYPERTENSION)', value: 'pih' }
          ...
          { id: 'ht_onset', label: 'YEAR OF ONSET', type: 'text', placeholder: 'YYYY', conditional: { fieldId: 'ht', operator: 'equals', value: true } },
          { id: 'ht_remarks', label: 'REMARKS', type: 'text', placeholder: 'Additional info', conditional: { fieldId: 'ht', operator: 'equals', value: true } },
          { id: 'ht_tablets', label: 'TABLETS', type: 'textarea', placeholder: 'Medicine name', conditional: { fieldId: 'ht', operator: 'equals', value: true } }
        ]
      },
      {
    ...
    sections: [
      {
        ...
        title: 'Patient Profile & Indications',
        fields: [
          { id: 'ptsName', label: 'Full Name', type: 'text', required: true },
          { id: 'husbandName', label: 'Husband / Father Name', type: 'text' },
          { id: 'phone', label: 'Phone Number', type: 'text' },
          { id: 'patientID', label: 'Patient ID', type: 'text' },
          { id: 'age', label: 'Age', type: 'number' },
          { id: 'dob', label: 'D.O.B.', type: 'date' },
          { id: 'gaia', label: 'Gestational Age (GA)', type: 'text', placeholder: 'X Wks + Y Days' },
          { id: 'indications', label: 'Indications for Scan', type: 'text' },
          { id: 'married_yrs', label: 'Married Years', type: 'number' },
          { id: 'married_mos', label: 'Months', type: 'number' },
          { id: 'history_personal', label: 'Personal Clinical History', type: 'textarea' }
        ]
      ...
      },
      {
        ...
        fields: [
          ...
          { id: 'cycle_type', label: 'Regularity', type: 'dropdown', options: [{ label: 'Regular', value: 'reg' }, { label: 'Irregular', value: 'irreg' }] },
          { id: 'menarche', label: 'Age at Menarche', type: 'number' },
          { id: 'cycle_duration', label: 'Duration of Cycle', type: 'text' },
          { id: 'bleeding_pv', label: 'Bleeding PV', type: 'textarea' },
          { id: 'menses_details', label: 'Menstrual Details', type: 'textarea' }
        ]
      },
      ...
      },
      {
        ...
        fields: [
          ...
          { id: 'dm_onset', label: 'Onset Date', type: 'date', conditional: { fieldId: 'dm_check', operator: 'equals', value: true } },
          { id: 'dm_status', label: 'Status', type: 'radio', options: [{ label: 'Present', value: 'pres' }, { label: 'Past', value: 'past' }], conditional: { fieldId: 'dm_check', operator: 'equals', value: true } },
          { id: 'dm_duration', label: 'Duration', type: 'text', conditional: { fieldId: 'dm_check', operator: 'equals', value: true } },
          { id: 'dm_notes', label: 'Remarks', type: 'text', conditional: { fieldId: 'dm_check', operator: 'equals', value: true } },
          ...
          { id: 'ht_tablets', label: 'Tablets / Dosage', type: 'textarea', conditional: { fieldId: 'ht_check', operator: 'equals', value: true } },
          { id: 'ht_status', label: 'Status', type: 'radio', options: [{ label: 'Present', value: 'pres' }, { label: 'Past', value: 'past' }], conditional: { fieldId: 'ht_check', operator: 'equals', value: true } },
          { id: 'ht_notes', label: 'Remarks', type: 'text', conditional: { fieldId: 'ht_check', operator: 'equals', value: true } },
    ...
    sections: [
      {
        ...
        title: 'Personal Information & FTS Context',
        fields: [
          { id: 'fts_name', label: 'NAME', type: 'text', required: true },
          { id: 'husbandName', label: 'HUSBAND / FATHER NAME', type: 'text' },
          { id: 'phone', label: 'PHONE NUMBER', type: 'text' },
          { id: 'fts_age', label: 'AGE', type: 'number' },
          { id: 'fts_ga', label: 'GESTATIONAL AGE (WKS)', type: 'number' },
          { id: 'fts_id', label: 'PATIENT ID', type: 'text' },
          { id: 'fts_indications', label: 'INDICATIONS FOR SCAN', type: 'text' },
          { id: 'fts_dob', label: 'D.O.B.', type: 'date' },
          { id: 'fts_married_yrs', label: 'MARRIED YEARS', type: 'number' },
          { id: 'fts_married_mos', label: 'MONTHS', type: 'number' }
        ]
  ...
  '2nd and 3rd trimester OB USG': {
    ...
    sections: [
      ...
      {
        id: 'ob23_nab_matrix',
        title: 'Fetal Anatomy N/AB Matrix',
        fields: [
          {
            id: 'nab_matrix',
            label: 'Fetal Anatomy Assessment (N/AB)',
            type: 'nab-matrix',
            rows: [
              'LV', '4 Chamber / OT', 'Spine', 'Face', 'Ear', 'Stomach',
              'Kidneys', 'Bladder', 'Limb Survey', 'Small Bowel', 'Large Bowel', 'PAMC'
  ...
  'OB-USG-Early Pregnancy': {
    ...
    sections: [
      ...
      },
      {
        ...
        title: 'Fetus A Parameters',
        fields: [
          { id: 'gs_a', label: 'Gestational Sac (Fetus A)', type: 'text', placeholder: 'Size / Position...' },
          { id: 'ys_a', label: 'Yolk Sac (Fetus A)', type: 'text', placeholder: 'Appearance...' },
          { id: 'crl_a', label: 'CRL (Fetus A)', type: 'text', placeholder: 'Measurement...' },
          { id: 'hr_a', label: 'Heart Rate (Fetus A)', type: 'text', placeholder: 'FH/rate...' },
          { id: 'lt_ov_a', label: 'Lt. Ovary (Position A)', type: 'text' },
          { id: 'rt_ov_a', label: 'Rt. Ovary (Position A)', type: 'text' }
        ]
      },
      {
        id: 'ep_fetus_b',
        title: 'Fetus B Parameters',
        conditional: { fieldId: 'ep_fetus_qty', operator: 'greater_than', value: 1 },
        fields: [
          { id: 'gs_b', label: 'Gestational Sac (Fetus B)', type: 'textarea', placeholder: 'Size / Position...' },
          { id: 'ys_b', label: 'Yolk Sac (Fetus B)', type: 'textarea', placeholder: 'Appearance...' },
          { id: 'crl_b', label: 'CRL (Fetus B)', type: 'textarea', placeholder: 'Measurement...' },
          { id: 'hr_b', label: 'Heart Rate (Fetus B)', type: 'textarea', placeholder: 'FH/rate...' },
          { id: 'lt_ov_b', label: 'Lt. Ovary (Position B)', type: 'textarea' },
          { id: 'rt_ov_b', label: 'Rt. Ovary (Position B)', type: 'textarea' }
        ]
      },
      {
        id: 'ep_fetus_c',
        title: 'Fetus C Parameters',
        conditional: { fieldId: 'ep_fetus_qty', operator: 'greater_than', value: 2 },
        fields: [
          { id: 'gs_c', label: 'Gestational Sac (Fetus C)', type: 'textarea', placeholder: 'Size / Position...' },
          { id: 'ys_c', label: 'Yolk Sac (Fetus C)', type: 'textarea', placeholder: 'Appearance...' },
          { id: 'crl_c', label: 'CRL (Fetus C)', type: 'textarea', placeholder: 'Measurement...' },
          { id: 'hr_c', label: 'Heart Rate (Fetus C)', type: 'textarea', placeholder: 'FH/rate...' },
          { id: 'lt_ov_c', label: 'Lt. Ovary (Position C)', type: 'textarea' },
          { id: 'rt_ov_c', label: 'Rt. Ovary (Position C)', type: 'textarea' }
        ]
      }
    ]
  }
